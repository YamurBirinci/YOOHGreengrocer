...
//------------------------------------MY PROFILE KISMININ KODU YUKARISI-------------------------------------------------------
    ...
    void to_orders(ActionEvent event) throws IOException {
        ...
        ObservableList<order> allMyOrders = FXCollections.observableArrayList(orderData.getCarrierCurrentOrders(loggedInCarrier.getUser_id()));
    ...
    void to_accept_order(ActionEvent event) {
        try {
            ...
            orderData.acceptedOrderbyCarrier(accept_OrderID_text.getText(), loggedInCarrier.getUser_id());
            activeOrderTable();
    ...
    void deliveryTable(){
        ObservableList<order> allDeliveredOrders = FXCollections.observableArrayList(orderData.getCarrierOrders(loggedInCarrier.getUser_id()));
