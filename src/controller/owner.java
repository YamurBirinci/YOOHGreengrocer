...
public class owner {
    ...
    ObservableList<String> statusList = FXCollections.observableArrayList("All", "Order Received", "Order Has Been Prepared", "Waiting for Carrier", "Received by Carrier", "Order Was delivered");
    ...
    void to_selected_status_table(ActionEvent event) {
        if("All".equals(choose_status_combobox.getValue())){
            ...
            ObservableList<order> allorderList = FXCollections.observableArrayList(orderData.getAllCustomerOrders());
            ...
            order_table.setItems(orderListByStatus);
        }
    }
