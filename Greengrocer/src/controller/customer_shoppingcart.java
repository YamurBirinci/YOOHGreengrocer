...
public class customer_shoppingcart implements Initializable {
    ...
    @FXML
    void close_warning3(ActionEvent event) throws IOException {
    ...
    void to_order(ActionEvent event) {
        ...
        else if (customer_cartData.getTotalPrice(loggedIn.getUser_id()) == 0){
            warning2.setVisible(true);
        }
        else if (loggedIn.getUser_phone() == null || loggedIn.getUser_address() == null){
            System.out.println("Phone: " + loggedIn.getUser_phone());
System.out.println("Address: " + loggedIn.getUser_address());
            warning3.setVisible(true);
        }
        else{
            cargo_total.setText("29.99₺");
            orderData.orderSave(loggedIn.getUser_id(), selectedValue, loggedIn.getUser_address());
            orderData.setOrderID();
            orderData.decreaseStocksAfterOrder(customer_cartData.myCart(loggedIn.getUser_id()));
            customer_cartData.cleanCart(loggedIn.getUser_id());
            after_cart_panel.setVisible(true);
            cart_panel.setVisible(false);
    ...
    public void getProduct(){
        ...
        try{
            List<customer_cart> myCart = customer_cartData.myCart(loggedIn.getUser_id());
    ...
    public void orderSummery() {
        double pt = customer_cartData.getTotalPrice(loggedIn.getUser_id());
