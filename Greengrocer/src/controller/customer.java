...
public class customer implements Initializable{
    ...
    void update_info(ActionEvent event) {
        ...
        if(phone != null && !checkPhone(phone)){
            ...
            warning1.setText("     Address must be 25-200 characters.");
        }
        else{
            boolean update2 = userData.updateInfoById(userID, name, surname, username, phone, user_address);
            if (update2 == true){
                users.loggedIN = userData.getThisUser(userID);
